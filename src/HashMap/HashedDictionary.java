...
// We are overriding this method for testing
// -------------------------

    /**
     *
     * @return  visual representation of the hashtable
     */
    @Override
    public String toString()
    {
        ...
        {
            if (hashTable[index] == null)
                str += "";  //i do not care if it is null i only want to see the places that have values or used to
            else if (hashTable[index] == AVAILABLE)
...
// -------------------------
    ...
    /**
     * Qradratically seachs the keys untill it finds a slot that is null
     * @param index counter
     * @param key   you are searching for
     * @return a index about -1 if the key was found or an empty slot
     */
        ...
        while ( !found && (hashTable[index] != null) )
        {
            if (hashTable[index] != AVAILABLE)
            {
                if (key.equals(hashTable[index].getKey()))
                    ...
                    index = ((index * index) + 1) % hashTable.length;         // Quadratic probing
            }
